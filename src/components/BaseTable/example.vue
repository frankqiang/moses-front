  ...
  <div class="base-table-example">
    ...
    <div class="example-section">
      ...
      <div class="demo-controls">
        <el-button type="primary" size="small" @click="generateLargeData(1000)">生成1000条数据</el-button>
        <el-button type="success" size="small" @click="generateLargeData(5000)">生成5000条数据</el-button>
        <el-button type="warning" size="small" @click="generateLargeData(10000)">生成10000条数据</el-button>
        <el-button size="small" @click="clearLargeData">清空数据</el-button>
      </div>
      <base-table
        :data="largeTableData"
    ...
    <div class="example-section">
      <h3>错误处理和数据异常示例</h3>
      <div class="demo-controls">
        <el-button type="success" size="small" @click="setNormalData">正常数据</el-button>
        <el-button type="danger" size="small" @click="setErrorData">异常数据</el-button>
        <el-button type="warning" size="small" @click="setLoadError">加载失败</el-button>
        <el-button size="small" @click="clearLoadError">清除错误</el-button>
      </div>
      <base-table
        :data="errorTableData"
    ...
    <div v-if="errorLogs.length > 0" class="error-logs">
      ...
      <el-button size="small" type="danger" @click="clearErrorLogs">清空日志</el-button>
    </div>
  </div>
</template>
