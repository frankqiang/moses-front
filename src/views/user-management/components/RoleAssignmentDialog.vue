<template>
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="800px" :close-on-click-modal="false"
        ...
        <div class="role-assignment-dialog">
                ...
                <div v-else class="roles-list">
                    <div v-for="role in currentRoles" :key="role.id" class="role-item current-role">
                        ...
                        <div class="role-actions">
                            <el-button type="danger" size="mini" icon="el-icon-delete" @click="handleRemoveRole(role)"
                                :loading="removing === role.id" :disabled="isRemoving || isAssigning">
                                移除
                            </el-button>
                        </div>
                    </div>
            ...
            <div class="available-roles-section">
                ...
                <div class="roles-filter">
                    <el-input v-model="roleFilter" placeholder="搜索角色名称或描述" size="small" prefix-icon="el-icon-search"
                        clearable @input="handleFilterRoles" />
                </div>
                ...
                <div v-else class="roles-list">
                    <div v-for="role in filteredAvailableRoles" :key="role.id" class="role-item available-role">
                        ...
                        <div class="role-actions">
                            <el-button type="primary" size="mini" icon="el-icon-plus" @click="handleAssignRole(role)"
                                :loading="assigning === role.id" :disabled="isRemoving || isAssigning">
                                分配
                            </el-button>
                        </div>
                    </div>
        ...
        <div slot="footer" class="dialog-footer">
            <el-button @click="handleClose" :disabled="isRemoving || isAssigning">
                关闭
            </el-button>
