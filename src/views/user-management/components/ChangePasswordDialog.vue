...
-->
<template>
    <el-dialog :visible.sync="dialogVisible" title="修改密码" width="680px" :close-on-click-modal="false"
        ...
        <el-form ref="changeForm" :model="formData" :rules="formRules" label-width="100px" class="change-form">
            ...
            <el-form-item label="当前密码" prop="currentPassword">
                <el-input v-model="formData.currentPassword" type="password" placeholder="请输入当前密码"
                    autocomplete="current-password" :security-mode="true" show-password />
            </el-form-item>

            <!-- 新密码 -->
            <el-form-item label="新密码" prop="newPassword">
                <secure-password-input v-model="formData.newPassword" placeholder="请输入新密码" :show-generate-button="true"
                    :security-mode="false" @password-generated="handlePasswordGenerated" />
            </el-form-item>
