 ...
 * 创建日期：2025-01-10
 * 修改记录:
 *   - 2025-01-10: 初始创建，定义料框表格和料垛表格的列配置
 */
...
// ==================== 料框表格列配置 ====================
export const BIN_TABLE_COLUMNS = [
  {
    prop: 'binCode',
    label: '料框编号',
    sortable: true,
  ...
  },
  {
    ...
    align: 'right',
    showOverflowTooltip: true,
    formatter: (row) => (row.weight ? row.weight.toFixed(3) : '-')
  },
  {
    prop: 'status',
    label: '状态',
...
// 料框表格默认可见列
export const BIN_DEFAULT_VISIBLE_COLUMNS = [
  'binCode',
  'specification',
  'productCode',
  'batchNumber',
...
// ==================== 料框状态配置（用于StatusTag组件） ====================
export const BIN_STATUS_TAG_CONFIG = BIN_STATUS_CONFIG

// ==================== 料垛状态配置（用于StatusTag组件） ====================
export const STACK_STATUS_TAG_CONFIG = STACK_STATUS_CONFIG

// ==================== 表格工具栏配置 ====================
export const BIN_TABLE_TOOLBAR_CONFIG = {
  ...
  enableDensity: true,
  columnSettings: {
    cacheKey: 'binManagementTableColumns'
  }
}
