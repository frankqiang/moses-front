...
<template>
    <div class="profile-container">
                    ...
                    <div class="settings-section">
                        ...
                        <div class="setting-item">
                            <div class="setting-content">
                                ...
                                <div class="setting-action">
                                    <el-select v-model="selectedTheme" placeholder="选择主题" size="small"
                                        style="width: 120px">
        ...
        <!-- 用户修改密码对话框 -->
        <change-password-dialog :visible.sync="changePasswordDialogVisible" @success="handleChangePasswordSuccess"
