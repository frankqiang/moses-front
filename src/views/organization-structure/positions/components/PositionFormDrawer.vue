...
<template>
    <el-drawer :visible.sync="drawerVisible" :title="drawerTitle" :size="700" :before-close="handleClose"
        :close-on-click-modal="false" class="position-form-drawer">
        <div class="drawer-content">
            <el-form ref="positionForm" :model="formData" :rules="formRules" :disabled="isViewMode" label-width="100px"
                size="medium">
                <!-- 基本信息 -->
                <div class="form-section">
                    ...
                    <el-form-item label="岗位编码" prop="code">
                        <el-input v-model="formData.code" placeholder="请输入岗位编码，将自动转为大写" maxlength="50" show-word-limit
                    ...
                    <el-form-item label="岗位类型" prop="type">
                        <el-select v-model="formData.type" placeholder="请选择岗位类型" style="width: 100%">
                            <el-option v-for="option in positionTypeOptions" :key="option.value" :label="option.label"
                                :value="option.value" />
                        </el-select>
                    </el-form-item>

                    <el-form-item label="岗位职责" prop="description">
                        <el-input v-model="formData.description" type="textarea" :rows="4" placeholder="请输入岗位职责描述（可选）"
                ...
                <div class="form-section">
                    ...
                    <el-form-item label="所属部门" prop="departmentId">
                        <el-select v-model="formData.departmentId" placeholder="请选择所属部门" filterable style="width: 100%">
                            <el-option v-for="option in departmentOptions" :key="option.id" :label="option.name"
                                :value="option.id" />
                        </el-select>
                    </el-form-item>

                    <el-form-item label="岗位级别" prop="level">
                        <el-input-number v-model="formData.level" :min="1" :max="20" placeholder="岗位级别"
                            style="width: 100%" />
                        <div class="form-tip">
                            数值越小级别越高，用于岗位层级管理
                        </div>
